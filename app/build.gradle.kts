plugins {
    ...
    alias(libs.plugins.kotlin.android) version "1.9.10" // Versão do Kotlin atualizada
    kotlin("kapt")
}
...
android {
    ...
    composeOptions {
        kotlinCompilerExtensionVersion = "1.5.3" // Certifique-se de que isso seja compatível com Kotlin 1.9.10
    }
